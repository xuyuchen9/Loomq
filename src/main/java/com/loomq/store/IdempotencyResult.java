...
public class IdempotencyResult {
    ...
    private IdempotencyResult(IdempotencyStatus status, Task task, String message) {
        this.status = status;
        this.task = task;
     ...
     * 存在未终态任务
     */
    public static IdempotencyResult activeExists(Task task) {
     ...
     * 存在已终态任务
     */
    public static IdempotencyResult terminalExists(Task task) {
